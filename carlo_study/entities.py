...
class Entity:
    ...
    def tick(self, dt: float):
        if self.movable:
            ...
            new_speed = self.inputAcceleration
...
class TextEntity(Entity):
    def __init__(self, center: Point, heading: float, movable: bool = False, friction: float  = 0):
        super(TextEntity, self).__init__(center, heading, movable)
